...
<script type="text/javascript">
    ...
    $(function () {
        $(".chat03_name").click(function () {
            $(this).css("color","blue");
            userName = this.text;
            $(".userName").html(userName);
            $(".message_box").empty();
            countRecord = 0;
            $.post("readrecord.do",{userName:userName},null,null);
        });
        $("#d1").ready(function () {
        ...
        $.post(
                ...
                function (data) {
                    ...
                    if (str!=newtiplist){
                        ...
                        str="";
                        $.each(data,function (i, item) {
                            $(".chat03_name").each(function (i, item2) {
                                if (item==item2.text&&item2.text!=userName){
                                    $(this).css("color","red");
                                }
                            });
        ...
        <div class="chatBox2">
            <div class="chatLeft">
                <div class="chat01">
                    <div class="chat01_title">
                        <ul class="talkTo">
                            <li><a href="javascript:;" class="username"></a></li></ul>
                ...
                <div class="chat02">
                    ...
                    <div class="chat02_bar">
                        <ul>
                            <li style="left: 20px; top: 10px; padding-left: 30px;">来源：<a href=#" target="_blank">客户</a></li>
            ...
            <div class="chatRight">
                <div class="chat03">
                    ...
                    <div class="chat03_content" style="position:absolute; height:370px;width:165px; overflow:auto">
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="javascript:;"></a>
                                <a href="javascript:;" class="chat03_name" style="color: blue;">${user.userName}</a>
                            </li>
                            </c:forEach>
                        </ul>
                    </div>
